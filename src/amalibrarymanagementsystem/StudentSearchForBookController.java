...
public class StudentSearchForBookController implements Initializable {
    ...
    @FXML
    public void StudentButtonBackClickedSearch(ActionEvent EventBackFsearch)throws IOException{
